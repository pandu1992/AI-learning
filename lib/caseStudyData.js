...
export const caseStudiesByField = {
  ...
  industry: [
    // ---------- 1 ----------
    {
      slug: "defect-vision-inspection",
      icon: "🔍",
      id: {
        title: "Baja Perkasa: Menemukan Cacat yang Terlewat Mata Manusia",
        subtitle: "Computer vision memeriksa kualitas produk di jalur produksi berkecepatan tinggi.",
        company: { name: "PT Baja Perkasa", industry: "Manufaktur komponen logam", location: "Cikarang, Jawa Barat", size: "1.400 karyawan, 3 lini produksi" },
        protagonist: { name: "Ir. Handoko", role: "Kepala Quality Control", quote: "Inspektur terbaik pun lelah setelah delapan jam. Cacat kecil yang lolos bisa berarti recall mahal atau pelanggan hilang." },
        sections: [
          { heading: "Latar", paragraphs: [
            "PT Baja Perkasa memproduksi ribuan komponen logam per jam. Pemeriksaan kualitas mengandalkan inspektur manual yang memeriksa sampel — tak mungkin memeriksa 100% produk pada kecepatan itu.",
            "Cacat halus seperti goresan mikro, retak rambut, atau penyok kecil sering lolos, terutama di akhir shift saat inspektur lelah.",
          ] },
          { heading: "Tantangan", paragraphs: [
            "Menambah inspektur mahal dan tetap terbatas oleh kelelahan manusia. Cacat sangat bervariasi bentuknya, dan kondisi pencahayaan pabrik tidak selalu ideal.",
            "Ir. Handoko butuh cara memeriksa 100% produk secara konsisten, tanpa memperlambat jalur produksi.",
          ] },
          { heading: "Keputusan & Pendekatan AI", paragraphs: [
            "Tim memasang kamera di atas konveyor dan melatih model computer vision (CNN) untuk mendeteksi cacat dari foto tiap produk yang lewat, secara real-time.",
            "Model dilatih dari ribuan foto produk berlabel (baik/cacat) oleh inspektur senior. Produk yang ditandai cacat otomatis disingkirkan; kasus ragu diteruskan ke inspektur manusia.",
          ] },
          { heading: "Hasil & Refleksi", paragraphs: [
            "Cacat yang lolos ke pelanggan turun 73%, dan pemeriksaan kini mencakup 100% produk, bukan sampel. Inspektur beralih ke menangani kasus sulit dan menganalisis pola cacat.",
            "Refleksi: model hanya sebaik data latihnya. Cacat jenis baru yang belum pernah dilihat model tetap butuh mata manusia — dan data cacat baru harus terus ditambahkan.",
          ] },
        ],
        techniques: [
          { name: "Computer Vision (CNN)", note: "Mendeteksi cacat dari foto produk di konveyor." },
          { name: "Inspeksi 100%", note: "Memeriksa setiap unit, bukan hanya sampel." },
          { name: "Human-in-the-loop", note: "Kasus ragu & cacat baru ditinjau inspektur." },
        ],
        results: ["Cacat lolos ke pelanggan turun 73%.", "Cakupan inspeksi: dari sampel → 100% produk.", "Inspektur fokus pada kasus sulit & analisis pola."],
        lessons: ["AI memeriksa konsisten tanpa lelah; manusia menangani hal baru.", "Model sebaik data latihnya — cacat baru harus terus ditambahkan.", "Inspeksi 100% mengubah kualitas dari 'sampling' jadi menyeluruh."],
        questions: ["Bagaimana menangani jenis cacat yang belum pernah dilihat model?", "Apa risiko jika model salah meloloskan produk cacat (false negative)?", "Kapan inspeksi manusia tetap wajib dipertahankan?"],
      },
      en: {
        title: "Baja Perkasa: Finding Defects the Human Eye Misses",
        subtitle: "Computer vision inspects product quality on a high-speed production line.",
        company: { name: "PT Baja Perkasa", industry: "Metal component manufacturing", location: "Cikarang, West Java", size: "1,400 employees, 3 production lines" },
        protagonist: { name: "Ir. Handoko", role: "Head of Quality Control", quote: "Even the best inspector tires after eight hours. A small defect that slips through can mean a costly recall or a lost customer." },
        sections: [
          { heading: "Background", paragraphs: [
            "PT Baja Perkasa produces thousands of metal components per hour. Quality checks relied on manual inspectors sampling parts — inspecting 100% at that speed was impossible.",
            "Subtle defects like micro-scratches, hairline cracks, or small dents often slipped through, especially late in a shift when inspectors were tired.",
          ] },
          { heading: "The Challenge", paragraphs: [
            "Hiring more inspectors is costly and still limited by human fatigue. Defects vary widely in shape, and factory lighting isn't always ideal.",
            "Ir. Handoko needed a way to inspect 100% of products consistently, without slowing the line.",
          ] },
          { heading: "The Decision & AI Approach", paragraphs: [
            "The team mounted cameras over the conveyor and trained a computer-vision model (CNN) to detect defects from a photo of each passing product, in real time.",
            "The model was trained on thousands of product photos labeled (good/defect) by senior inspectors. Flagged products are auto-removed; uncertain cases go to a human inspector.",
          ] },
          { heading: "Results & Reflection", paragraphs: [
            "Defects reaching customers fell 73%, and inspection now covers 100% of products, not a sample. Inspectors shifted to handling hard cases and analyzing defect patterns.",
            "Reflection: a model is only as good as its training data. New defect types the model has never seen still need human eyes — and new defect data must keep being added.",
          ] },
        ],
        techniques: [
          { name: "Computer Vision (CNN)", note: "Detects defects from product photos on the conveyor." },
          { name: "100% inspection", note: "Checks every unit, not just a sample." },
          { name: "Human-in-the-loop", note: "Uncertain cases & new defects reviewed by inspectors." },
        ],
        results: ["Defects reaching customers down 73%.", "Inspection coverage: sample → 100% of products.", "Inspectors focus on hard cases & pattern analysis."],
        lessons: ["AI inspects consistently without fatigue; humans handle novelty.", "A model is only as good as its data — keep adding new defects.", "100% inspection turns quality from sampling into full coverage."],
        questions: ["How to handle defect types the model has never seen?", "What is the risk if the model wrongly passes a defective product (false negative)?", "When must human inspection still be kept?"],
      },
      visualization: {
        type: "beforeAfter",
        caption: { id: "Dampak inspeksi berbasis computer vision.", en: "Impact of computer-vision-based inspection." },
        metrics: [
          { label: { id: "Cacat lolos ke pelanggan (indeks)", en: "Defects reaching customers (index)" }, before: 100, after: 27, unit: "", betterWhenLower: true },
          { label: { id: "Cakupan inspeksi", en: "Inspection coverage" }, before: 12, after: 100, unit: "%" },
          { label: { id: "Keluhan kualitas (indeks)", en: "Quality complaints (index)" }, before: 100, after: 41, unit: "", betterWhenLower: true },
        ],
      },
      analysisViz: {
        type: "pipeline",
        caption: { id: "Bagaimana tiap produk diperiksa saat melintasi konveyor.", en: "How each product is inspected as it passes the conveyor." },
        stages: [
          { icon: "📸", label: { id: "Foto produk", en: "Product photo" }, detail: { id: "Kamera memotret tiap unit yang lewat di konveyor.", en: "A camera photographs each unit passing on the conveyor." } },
          { icon: "🩹", label: { id: "Normalisasi", en: "Normalize" }, detail: { id: "Menormalkan pencahayaan & sudut agar konsisten.", en: "Normalize lighting & angle for consistency." } },
          { icon: "🔎", label: { id: "CNN memeriksa", en: "CNN inspects" }, detail: { id: "Konvolusi mendeteksi goresan, retak, atau penyok.", en: "Convolution detects scratches, cracks, or dents." } },
          { icon: "🚦", label: { id: "Baik / cacat", en: "Good / defect" }, detail: { id: "Skor cacat + tingkat keyakinan dihitung.", en: "A defect score + confidence is computed." } },
          { icon: "🦾", label: { id: "Aksi otomatis", en: "Auto action" }, detail: { id: "Produk cacat disingkirkan; kasus ragu ke inspektur.", en: "Defective products removed; uncertain cases to an inspector." } },
        ],
      },
    },
    ...
    // ---------- 2 ----------
    {
      ...
      icon: "🛠️",
      id: {
        title: "Semen Nusantara: Mendengar Mesin Sebelum Rusak",
        subtitle: "Pemeliharaan prediktif dari data sensor menekan kerusakan mendadak.",
        company: { name: "PT Semen Nusantara", industry: "Manufaktur semen", location: "Tuban, Jawa Timur", size: "2.100 karyawan, pabrik 24 jam" },
        protagonist: { name: "Bu Sari", role: "Manajer Keandalan Pabrik", quote: "Kerusakan mendadak satu motor bisa menghentikan seluruh lini berjam-jam. Kami ingin memperbaiki tepat sebelum rusak — bukan sesudah." },
        sections: [
          { heading: "Latar", paragraphs: [
            "Pabrik semen beroperasi 24 jam dengan mesin berat: motor, gearbox, dan kiln. Kerusakan tak terduga sangat mahal — menghentikan produksi dan merusak jadwal.",
            "Selama ini pemeliharaan bersifat terjadwal (setiap sekian jam) atau reaktif (perbaiki setelah rusak). Keduanya tidak optimal: terlalu sering = boros; terlalu jarang = berisiko.",
          ] },
          { heading: "Tantangan", paragraphs: [
            "Mesin dilengkapi sensor (getaran, suhu, arus listrik) yang merekam data terus-menerus, tapi menafsirkan tren gabungannya secara manual sangat sulit.",
            "Bu Sari ingin memprediksi kapan sebuah mesin akan gagal, agar perbaikan dijadwalkan tepat waktu — tidak terlalu dini, tidak terlambat.",
          ] },
          { heading: "Keputusan & Pendekatan AI", paragraphs: [
            "Tim membangun model pemeliharaan prediktif yang memantau tren sensor untuk menaksir 'sisa umur' komponen dan menandai anomali yang mendahului kerusakan.",
            "Ketika risiko melewati ambang, sistem memberi peringatan agar tim menjadwalkan perbaikan pada waktu henti terencana — bukan saat mesin tiba-tiba mati.",
          ] },
          { heading: "Hasil & Refleksi", paragraphs: [
            "Kerusakan mendadak (downtime tak terencana) turun 38%, dan biaya pemeliharaan turun karena suku cadang diganti saat benar-benar perlu, bukan terlalu dini.",
            "Refleksi: menyetel ambang itu krusial — terlalu sensitif menimbulkan alarm palsu (kelelahan alarm); terlalu longgar melewatkan kerusakan. Kepercayaan teknisi tumbuh saat prediksi terbukti akurat.",
          ] },
        ],
        techniques: [
          { name: "Deteksi Anomali", note: "Menandai pola sensor yang menyimpang dari normal." },
          { name: "Prediksi sisa umur (regresi)", note: "Menaksir kapan komponen akan gagal." },
          { name: "Deret waktu sensor", note: "Memantau getaran, suhu, arus secara real-time." },
        ],
        results: ["Downtime tak terencana turun 38%.", "Biaya pemeliharaan turun (ganti saat perlu).", "Perbaikan dijadwalkan pada waktu henti terencana."],
        lessons: ["Prediktif mengalahkan reaktif & terjadwal-buta.", "Ambang alarm menyeimbangkan sensitivitas vs kelelahan alarm.", "Kepercayaan teknisi dibangun oleh prediksi yang akurat."],
        questions: ["Bagaimana menyeimbangkan alarm dini vs alarm palsu?", "Apa konsekuensi jika model melewatkan kerusakan (false negative)?", "Data sensor apa yang paling prediktif untuk tiap mesin?"],
      },
      en: {
        title: "Semen Nusantara: Hearing a Machine Before It Fails",
        subtitle: "Predictive maintenance from sensor data cuts sudden breakdowns.",
        company: { name: "PT Semen Nusantara", industry: "Cement manufacturing", location: "Tuban, East Java", size: "2,100 employees, 24-hour plant" },
        protagonist: { name: "Bu Sari", role: "Plant Reliability Manager", quote: "One motor's sudden failure can halt the whole line for hours. We wanted to fix things right before they break — not after." },
        sections: [
          { heading: "Background", paragraphs: [
            "The cement plant runs 24 hours with heavy machines: motors, gearboxes, and kilns. Unexpected breakdowns are very costly — halting production and wrecking schedules.",
            "Maintenance had been either scheduled (every so many hours) or reactive (fix after failure). Both are suboptimal: too often = wasteful; too rarely = risky.",
          ] },
          { heading: "The Challenge", paragraphs: [
            "The machines have sensors (vibration, temperature, current) recording data continuously, but interpreting their combined trend by hand is very hard.",
            "Bu Sari wanted to predict when a machine would fail, so repairs could be scheduled just in time — not too early, not too late.",
          ] },
          { heading: "The Decision & AI Approach", paragraphs: [
            "The team built a predictive-maintenance model that monitors sensor trends to estimate a component's 'remaining life' and flags anomalies that precede failures.",
            "When risk crosses a threshold, the system alerts the team to schedule the repair during planned downtime — not when the machine suddenly dies.",
          ] },
          { heading: "Results & Reflection", paragraphs: [
            "Sudden breakdowns (unplanned downtime) fell 38%, and maintenance costs dropped because parts were replaced when actually needed, not too early.",
            "Reflection: tuning the threshold is crucial — too sensitive causes false alarms (alarm fatigue); too loose misses failures. Technician trust grew once predictions proved accurate.",
          ] },
        ],
        techniques: [
          { name: "Anomaly Detection", note: "Flags sensor patterns deviating from normal." },
          { name: "Remaining-life prediction (regression)", note: "Estimates when a component will fail." },
          { name: "Sensor time-series", note: "Monitors vibration, temperature, current in real time." },
        ],
        results: ["Unplanned downtime down 38%.", "Maintenance cost down (replace when needed).", "Repairs scheduled during planned downtime."],
        lessons: ["Predictive beats reactive & blind-scheduled.", "The alarm threshold balances sensitivity vs alarm fatigue.", "Technician trust is built by accurate predictions."],
        questions: ["How to balance early alarms vs false alarms?", "What are the consequences if the model misses a failure (false negative)?", "Which sensor data is most predictive for each machine?"],
      },
      visualization: {
        type: "beforeAfter",
        caption: { id: "Dampak pemeliharaan prediktif pada keandalan pabrik.", en: "Impact of predictive maintenance on plant reliability." },
        metrics: [
          { label: { id: "Downtime tak terencana (jam/bulan)", en: "Unplanned downtime (hrs/month)" }, before: 42, after: 26, unit: "j", betterWhenLower: true, decimals: 0 },
          { label: { id: "Biaya pemeliharaan (indeks)", en: "Maintenance cost (index)" }, before: 100, after: 79, unit: "", betterWhenLower: true },
          { label: { id: "Ketersediaan mesin", en: "Machine availability" }, before: 91, after: 97, unit: "%" },
        ],
      },
      analysisViz: {
        type: "threshold",
        caption: { id: "Menyetel ambang risiko kerusakan: rendah = tangkap lebih banyak kegagalan dini (recall) tapi lebih banyak alarm palsu.", en: "Tuning the failure-risk threshold: lower = catch more early failures (recall) but more false alarms." },
        positiveLabel: { id: "Akan rusak", en: "Will fail" },
        negativeLabel: { id: "Sehat", en: "Healthy" },
        dist: { pos: [0.93, 0.86, 0.78, 0.7, 0.62, 0.54, 0.46], neg: [0.07, 0.15, 0.23, 0.31, 0.39, 0.47, 0.55, 0.63, 0.22, 0.35, 0.28] },
      },
    },

    // ---------- 3 ----------
    {
      slug: "production-demand-forecast",
      icon: "📦",
      id: {
        title: "Tekstil Harmoni: Menyelaraskan Produksi dengan Permintaan",
        subtitle: "Peramalan permintaan menekan kelebihan stok sekaligus kehabisan bahan.",
        company: { name: "PT Tekstil Harmoni", industry: "Manufaktur tekstil & garmen", location: "Bandung, Jawa Barat", size: "3.500 karyawan" },
        protagonist: { name: "Pak Anton", role: "Direktur Perencanaan Produksi", quote: "Produksi berlebih menumpuk di gudang jadi modal mati; kurang produksi berarti pesanan besar lepas. Kami butuh menebak permintaan lebih baik." },
        sections: [
          { heading: "Latar", paragraphs: [
            "Permintaan tekstil sangat musiman: lonjakan menjelang hari raya, tren mode yang cepat berubah, dan pesanan ekspor yang fluktuatif. Perencanaan produksi masih mengandalkan intuisi manajer.",
            "Akibatnya: sebagian model kain menumpuk tak terjual, sementara yang laris kehabisan bahan baku saat dibutuhkan.",
          ] },
          { heading: "Tantangan", paragraphs: [
            "Setiap produk punya pola permintaan sendiri, dipengaruhi musim, tren, dan promosi. Menebak manual untuk ratusan SKU tidak konsisten.",
            "Pak Anton butuh peramalan yang menangkap musiman & tren, untuk merencanakan produksi dan pembelian bahan baku lebih tepat.",
          ] },
          { heading: "Keputusan & Pendekatan AI", paragraphs: [
            "Tim membangun model peramalan deret waktu yang memprediksi permintaan per produk untuk beberapa minggu ke depan, memakai riwayat penjualan + faktor musiman & promosi.",
            "Prediksi menjadi dasar rencana produksi dan pemesanan bahan. Perencana tetap bisa menyesuaikan berdasarkan info pasar terbaru.",
          ] },
          { heading: "Hasil & Refleksi", paragraphs: [
            "Kelebihan stok turun 31% dan kejadian kehabisan bahan baku turun 44%, membebaskan modal kerja dan menyelamatkan pesanan besar.",
            "Refleksi: peramalan bukan ramalan pasti. Tren mode viral yang tiba-tiba tetap mengejutkan model — kombinasi ramalan mesin + intuisi pasar manusia bekerja paling baik.",
          ] },
        ],
        techniques: [
          { name: "Peramalan Deret Waktu", note: "Memprediksi permintaan per produk." },
          { name: "Faktor musiman & promosi", note: "Menangkap lonjakan hari raya & efek promo." },
          { name: "Perencanaan berbasis prediksi", note: "Menyelaraskan produksi & pembelian bahan." },
        ],
        results: ["Kelebihan stok turun 31%.", "Kehabisan bahan baku turun 44%.", "Modal kerja lebih efisien; pesanan besar terselamatkan."],
        lessons: ["Peramalan menyelaraskan produksi dengan permintaan nyata.", "Tren viral tetap butuh penilaian manusia.", "Rencana berbasis data mengurangi modal mati di gudang."],
        questions: ["Bagaimana model menangani produk baru tanpa riwayat?", "Apa risiko terlalu percaya pada satu angka ramalan?", "Bagaimana menggabungkan intuisi pasar dengan prediksi model?"],
      },
      en: {
        title: "Tekstil Harmoni: Aligning Production with Demand",
        subtitle: "Demand forecasting cuts both overstock and material shortages.",
        company: { name: "PT Tekstil Harmoni", industry: "Textile & garment manufacturing", location: "Bandung, West Java", size: "3,500 employees" },
        protagonist: { name: "Pak Anton", role: "Director of Production Planning", quote: "Overproduction piles up in the warehouse as dead capital; underproduction means losing big orders. We needed to guess demand better." },
        sections: [
          { heading: "Background", paragraphs: [
            "Textile demand is highly seasonal: spikes before holidays, fast-changing fashion trends, and fluctuating export orders. Production planning still relied on manager intuition.",
            "As a result, some fabric styles piled up unsold, while best-sellers ran out of raw material when needed.",
          ] },
          { heading: "The Challenge", paragraphs: [
            "Each product has its own demand pattern, driven by season, trend, and promotions. Guessing manually for hundreds of SKUs can't be consistent.",
            "Pak Anton needed forecasting that captured seasonality & trend, to plan production and raw-material purchasing more precisely.",
          ] },
          { heading: "The Decision & AI Approach", paragraphs: [
            "The team built a time-series forecasting model predicting per-product demand for the coming weeks, using sales history + seasonal & promotion factors.",
            "Forecasts became the basis for production plans and material orders. Planners could still adjust based on the latest market info.",
          ] },
          { heading: "Results & Reflection", paragraphs: [
            "Overstock fell 31% and raw-material stockouts fell 44%, freeing working capital and saving big orders.",
            "Reflection: a forecast isn't certainty. Sudden viral fashion trends still surprise the model — combining machine forecasts with human market intuition works best.",
          ] },
        ],
        techniques: [
          { name: "Time-Series Forecasting", note: "Predicts per-product demand." },
          { name: "Seasonal & promotion factors", note: "Captures holiday spikes & promo effects." },
          { name: "Prediction-based planning", note: "Aligns production & material purchasing." },
        ],
        results: ["Overstock down 31%.", "Raw-material stockouts down 44%.", "More efficient working capital; big orders saved."],
        lessons: ["Forecasting aligns production with real demand.", "Viral trends still need human judgment.", "Data-based planning reduces dead capital in the warehouse."],
        questions: ["How does the model handle new products with no history?", "What is the risk of over-trusting a single forecast number?", "How to combine market intuition with model predictions?"],
      },
      visualization: {
        type: "beforeAfter",
        caption: { id: "Dampak peramalan permintaan pada perencanaan produksi.", en: "Impact of demand forecasting on production planning." },
        metrics: [
          { label: { id: "Kelebihan stok (indeks)", en: "Overstock (index)" }, before: 100, after: 69, unit: "", betterWhenLower: true },
          { label: { id: "Kehabisan bahan (indeks)", en: "Material stockouts (index)" }, before: 100, after: 56, unit: "", betterWhenLower: true },
          { label: { id: "Ketepatan rencana produksi", en: "Production plan accuracy" }, before: 64, after: 86, unit: "%" },
        ],
      },
      analysisViz: {
        type: "pipeline",
        caption: { id: "Bagaimana data penjualan menjadi rencana produksi.", en: "How sales data becomes a production plan." },
        stages: [
          { icon: "🧾", label: { id: "Data penjualan", en: "Sales data" }, detail: { id: "Riwayat penjualan per produk & SKU dikumpulkan.", en: "Sales history per product & SKU is collected." } },
          { icon: "📅", label: { id: "Musiman & promo", en: "Seasonality & promo" }, detail: { id: "Memisahkan tren, musim (hari raya), dan efek promosi.", en: "Separates trend, season (holidays), and promo effects." } },
          { icon: "📈", label: { id: "Ramalan permintaan", en: "Demand forecast" }, detail: { id: "Memproyeksikan permintaan beberapa minggu ke depan.", en: "Projects demand for the coming weeks." } },
          { icon: "🏭", label: { id: "Rencana produksi", en: "Production plan" }, detail: { id: "Menerjemahkan ramalan ke jadwal produksi & bahan.", en: "Translates the forecast to production & material schedules." } },
          { icon: "🧑‍💼", label: { id: "Penyesuaian perencana", en: "Planner adjust" }, detail: { id: "Perencana menyesuaikan dengan info pasar terbaru.", en: "Planners adjust with the latest market info." } },
        ],
      },
    },
    ...
    // ---------- 4 ----------
    {
      slug: "energy-optimization-rl",
      icon: "⚡",
      id: {
        title: "Kimia Sentosa: Menghemat Energi Tanpa Menurunkan Output",
        subtitle: "Reinforcement learning mengatur parameter proses untuk efisiensi energi.",
        company: { name: "PT Kimia Sentosa", industry: "Manufaktur kimia/proses", location: "Gresik, Jawa Timur", size: "1.800 karyawan" },
        protagonist: { name: "Ir. Dewi", role: "Kepala Efisiensi Energi", quote: "Energi adalah biaya terbesar kami. Setiap 1% penghematan bernilai miliaran — tapi tak boleh mengorbankan mutu produk." },
        sections: [
          { heading: "Latar", paragraphs: [
            "Pabrik proses kimia mengonsumsi energi besar untuk pemanasan, pendingin, dan tekanan. Parameter proses (suhu, laju aliran) selama ini disetel operator berdasarkan pengalaman.",
            "Setelan yang 'aman' sering boros energi, karena operator cenderung memberi margin lebar untuk menghindari risiko.",
          ] },
          { heading: "Tantangan", paragraphs: [
            "Mengubah satu parameter memengaruhi yang lain dengan konsekuensi tertunda — sulit dioptimalkan secara manual. Terlalu agresif menghemat bisa menurunkan mutu atau membahayakan keselamatan.",
            "Ir. Dewi butuh cara menemukan setelan paling hemat energi yang tetap menjaga mutu & keselamatan.",
          ] },
          { heading: "Keputusan & Pendekatan AI", paragraphs: [
            "Tim menerapkan reinforcement learning: agen mengamati state proses (suhu, tekanan, output) dan menyarankan penyesuaian parameter, dengan reward menyeimbangkan penghematan energi dan mutu produk.",
            "Agen dilatih di simulasi digital-twin lebih dulu, lalu saran diterapkan bertahap dengan pengawasan operator (batas keselamatan tetap dijaga sistem kontrol).",
          ] },
          { heading: "Hasil & Refleksi", paragraphs: [
            "Konsumsi energi turun 14% tanpa penurunan mutu produk atau kompromi keselamatan — penghematan besar pada skala pabrik.",
            "Refleksi: mendesain reward itu kritis. Reward yang hanya mengejar hemat energi bisa membahayakan mutu. Batas keselamatan keras (hard constraints) dan pengawasan manusia tetap wajib.",
          ] },
        ],
        techniques: [
          { name: "Reinforcement Learning", note: "Agen belajar kebijakan setelan parameter dari reward." },
          { name: "Digital twin (simulasi)", note: "Melatih agen dengan aman sebelum ke pabrik nyata." },
          { name: "Batas keselamatan", note: "Constraint keras menjaga mutu & keselamatan." },
        ],
        results: ["Konsumsi energi turun 14%.", "Mutu produk & keselamatan terjaga.", "Penghematan besar pada skala pabrik."],
        lessons: ["Keputusan dengan konsekuensi tertunda cocok untuk RL.", "Desain reward menentukan perilaku agen — hati-hati.", "Batas keselamatan keras + pengawasan manusia wajib."],
        questions: ["Bagaimana mendesain reward yang menyeimbangkan energi vs mutu?", "Mengapa melatih di digital twin dulu, bukan langsung di pabrik?", "Bagaimana menjamin agen tak melanggar batas keselamatan?"],
      },
      en: {
        title: "Kimia Sentosa: Saving Energy Without Lowering Output",
        subtitle: "Reinforcement learning tunes process parameters for energy efficiency.",
        company: { name: "PT Kimia Sentosa", industry: "Chemical/process manufacturing", location: "Gresik, East Java", size: "1,800 employees" },
        protagonist: { name: "Ir. Dewi", role: "Head of Energy Efficiency", quote: "Energy is our biggest cost. Every 1% saved is worth billions — but never at the expense of product quality." },
        sections: [
          { heading: "Background", paragraphs: [
            "The chemical process plant consumes huge energy for heating, cooling, and pressure. Process parameters (temperature, flow rate) had been set by operators based on experience.",
            "'Safe' settings are often energy-wasteful, because operators tend to leave wide margins to avoid risk.",
          ] },
          { heading: "The Challenge", paragraphs: [
            "Changing one parameter affects others with delayed consequences — hard to optimize manually. Saving too aggressively can lower quality or endanger safety.",
            "Ir. Dewi needed a way to find the most energy-efficient settings that still preserve quality & safety.",
          ] },
          { heading: "The Decision & AI Approach", paragraphs: [
            "The team applied reinforcement learning: an agent observes the process state (temperature, pressure, output) and suggests parameter adjustments, with a reward balancing energy savings and product quality.",
            "The agent was trained on a digital-twin simulation first, then suggestions were applied gradually with operator oversight (hard safety limits stay enforced by the control system).",
          ] },
          { heading: "Results & Reflection", paragraphs: [
            "Energy consumption fell 14% with no drop in product quality or safety compromise — a large saving at plant scale.",
            "Reflection: reward design is critical. A reward chasing only energy savings could endanger quality. Hard safety constraints and human oversight remain mandatory.",
          ] },
        ],
        techniques: [
          { name: "Reinforcement Learning", note: "The agent learns a parameter-setting policy from rewards." },
          { name: "Digital twin (simulation)", note: "Trains the agent safely before the real plant." },
          { name: "Safety constraints", note: "Hard constraints protect quality & safety." },
        ],
        results: ["Energy consumption down 14%.", "Product quality & safety preserved.", "Large savings at plant scale."],
        lessons: ["Delayed-consequence decisions suit RL.", "Reward design shapes agent behavior — be careful.", "Hard safety limits + human oversight are mandatory."],
        questions: ["How to design a reward balancing energy vs quality?", "Why train on a digital twin first, not the real plant?", "How to guarantee the agent won't breach safety limits?"],
      },
      visualization: {
        type: "beforeAfter",
        caption: { id: "Dampak optimasi energi berbasis RL.", en: "Impact of RL-based energy optimization." },
        metrics: [
          { label: { id: "Konsumsi energi (indeks)", en: "Energy consumption (index)" }, before: 100, after: 86, unit: "", betterWhenLower: true },
          { label: { id: "Output produksi (indeks)", en: "Production output (index)" }, before: 100, after: 100, unit: "" },
          { label: { id: "Biaya energi (indeks)", en: "Energy cost (index)" }, before: 100, after: 86, unit: "", betterWhenLower: true },
        ],
      },
      analysisViz: {
        type: "pipeline",
        caption: { id: "Siklus keputusan agen RL untuk efisiensi energi.", en: "The RL agent's decision cycle for energy efficiency." },
        stages: [
          { icon: "🌡️", label: { id: "Baca proses (state)", en: "Read process (state)" }, detail: { id: "Suhu, tekanan, laju aliran, dan output dibaca.", en: "Temperature, pressure, flow rate, and output are read." } },
          { icon: "🤖", label: { id: "Agen menyarankan", en: "Agent suggests" }, detail: { id: "Kebijakan menyarankan penyesuaian parameter.", en: "The policy suggests a parameter adjustment." } },
          { icon: "🛡️", label: { id: "Cek keselamatan", en: "Safety check" }, detail: { id: "Sistem kontrol menolak saran yang melanggar batas.", en: "The control system rejects out-of-bounds suggestions." } },
          { icon: "⚙️", label: { id: "Terapkan", en: "Apply" }, detail: { id: "Parameter disesuaikan pada proses nyata.", en: "Parameters are adjusted on the real process." } },
          { icon: "🌱", label: { id: "Reward & belajar", en: "Reward & learn" }, detail: { id: "Hemat energi + mutu terjaga memberi reward; agen belajar.", en: "Energy saved + quality kept give reward; the agent learns." } },
        ],
      },
    },
    ...
    // ---------- 5 ----------
    {
      slug: "warehouse-robot-optimization",
      icon: "🤖",
      id: {
        title: "Logistik Cepat: Robot Gudang yang Menemukan Jalur Tercepat",
        subtitle: "Optimasi rute & tata letak mempercepat pemenuhan pesanan.",
        company: { name: "PT Logistik Cepat", industry: "Pergudangan & fulfillment", location: "Bekasi, Jawa Barat", size: "Gudang 40.000 m², 120 robot" },
        protagonist: { name: "Pak Rudi", role: "Kepala Operasi Gudang", quote: "Jarak yang ditempuh robot untuk mengambil satu pesanan menentukan berapa cepat pelanggan menerima paketnya — dan berapa banyak pesanan yang bisa kami tangani." },
        sections: [
          { heading: "Latar", paragraphs: [
            "Gudang fulfillment PT Logistik Cepat memakai robot untuk mengambil barang. Efisiensi rute robot dan penempatan barang menentukan kecepatan & kapasitas pemenuhan pesanan.",
            "Penempatan barang statis dan rute sederhana membuat robot menempuh jarak lebih jauh dari yang perlu, terutama saat pola pesanan berubah.",
          ] },
          { heading: "Tantangan", paragraphs: [
            "Rute optimal berubah tiap saat sesuai pesanan yang masuk, dan barang yang sering dipesan bersama sebaiknya diletakkan berdekatan — tapi pola itu berubah seiring waktu.",
            "Pak Rudi butuh sistem yang mengoptimalkan rute pengambilan secara dinamis dan menata ulang penempatan barang berdasarkan pola pesanan.",
          ] },
          { heading: "Keputusan & Pendekatan AI", paragraphs: [
            "Tim memakai kombinasi: optimasi rute (mirip perencanaan jalur RL/graf) untuk pengambilan tercepat, dan analisis pola pesanan (asosiasi) untuk menata barang yang sering dibeli bersama agar berdekatan.",
            "Sistem menyesuaikan rute secara real-time dan memberi rekomendasi penataan ulang berkala. Operator meninjau rekomendasi penataan sebelum diterapkan.",
          ] },
          { heading: "Hasil & Refleksi", paragraphs: [
            "Jarak tempuh robot per pesanan turun 29%, mempercepat waktu pemenuhan dan menaikkan kapasitas gudang tanpa menambah robot.",
            "Refleksi: optimasi harus mempertimbangkan kendala nyata (lorong sempit, keselamatan pekerja manusia yang berbagi ruang). Solusi terbaik memadukan algoritma dengan pengetahuan operasional.",
          ] },
        ],
        techniques: [
          { name: "Optimasi Rute / Perencanaan Jalur", note: "Menemukan rute pengambilan tercepat secara dinamis." },
          { name: "Analisis pola pesanan (asosiasi)", note: "Menata barang yang sering dibeli bersama berdekatan." },
          { name: "Penyesuaian real-time", note: "Rute diperbarui sesuai pesanan yang masuk." },
        ],
        results: ["Jarak tempuh robot per pesanan turun 29%.", "Waktu pemenuhan pesanan lebih cepat.", "Kapasitas gudang naik tanpa menambah robot."],
        lessons: ["Optimasi rute langsung berdampak pada kecepatan & kapasitas.", "Kendala nyata (lorong, keselamatan) harus masuk model.", "Algoritma + pengetahuan operasional > salah satu saja."],
        questions: ["Bagaimana memastikan keselamatan saat robot & pekerja berbagi ruang?", "Kapan menata ulang gudang sepadan dengan biayanya?", "Metrik apa: jarak tempuh atau total waktu pemenuhan?"],
      },
      en: {
        title: "Logistik Cepat: Warehouse Robots Finding the Fastest Path",
        subtitle: "Route & layout optimization speeds up order fulfillment.",
        company: { name: "PT Logistik Cepat", industry: "Warehousing & fulfillment", location: "Bekasi, West Java", size: "40,000 m² warehouse, 120 robots" },
        protagonist: { name: "Pak Rudi", role: "Head of Warehouse Operations", quote: "The distance a robot travels to pick one order decides how fast the customer gets their package — and how many orders we can handle." },
        sections: [
          { heading: "Background", paragraphs: [
            "Logistik Cepat's fulfillment warehouse uses robots to pick items. Robot route efficiency and item placement determine order-fulfillment speed & capacity.",
            "Static item placement and simple routes made robots travel farther than necessary, especially as order patterns shifted.",
          ] },
          { heading: "The Challenge", paragraphs: [
            "The optimal route changes constantly with incoming orders, and items often ordered together should be placed near each other — but that pattern shifts over time.",
            "Pak Rudi needed a system to dynamically optimize picking routes and re-arrange item placement based on order patterns.",
          ] },
          { heading: "The Decision & AI Approach", paragraphs: [
            "The team used a combination: route optimization (like RL/graph path-planning) for the fastest picking, and order-pattern analysis (association) to place frequently co-bought items nearby.",
            "The system adjusts routes in real time and gives periodic re-arrangement recommendations. Operators review layout recommendations before applying them.",
          ] },
          { heading: "Results & Reflection", paragraphs: [
            "Robot travel distance per order fell 29%, speeding up fulfillment time and raising warehouse capacity without adding robots.",
            "Reflection: optimization must respect real constraints (narrow aisles, safety of human workers sharing the space). The best solution blends algorithms with operational knowledge.",
          ] },
        ],
        techniques: [
          { name: "Route Optimization / Path Planning", note: "Dynamically finds the fastest picking route." },
          { name: "Order-pattern analysis (association)", note: "Places co-bought items near each other." },
          { name: "Real-time adjustment", note: "Routes update with incoming orders." },
        ],
        results: ["Robot travel per order down 29%.", "Faster order fulfillment.", "Higher warehouse capacity without more robots."],
        lessons: ["Route optimization directly impacts speed & capacity.", "Real constraints (aisles, safety) must be in the model.", "Algorithms + operational knowledge beat either alone."],
        questions: ["How to ensure safety when robots & workers share space?", "When is re-arranging the warehouse worth its cost?", "Which metric: travel distance or total fulfillment time?"],
      },
      visualization: {
        type: "beforeAfter",
        caption: { id: "Dampak optimasi rute & tata letak gudang.", en: "Impact of warehouse route & layout optimization." },
        metrics: [
          { label: { id: "Jarak tempuh per pesanan (indeks)", en: "Travel per order (index)" }, before: 100, after: 71, unit: "", betterWhenLower: true },
          { label: { id: "Waktu pemenuhan (menit)", en: "Fulfillment time (min)" }, before: 18, after: 12, unit: " mnt", betterWhenLower: true, decimals: 0 },
          { label: { id: "Kapasitas pesanan/hari (indeks)", en: "Orders/day capacity (index)" }, before: 100, after: 133, unit: "" },
        ],
      },
      analysisViz: {
        type: "pipeline",
        caption: { id: "Bagaimana sebuah pesanan menjadi rute robot tercepat.", en: "How an order becomes the fastest robot route." },
        stages: [
          { icon: "🛒", label: { id: "Pesanan masuk", en: "Order in" }, detail: { id: "Daftar item yang harus diambil diterima sistem.", en: "The list of items to pick is received." } },
          { icon: "🗺️", label: { id: "Peta gudang", en: "Warehouse map" }, detail: { id: "Sistem mengetahui lokasi tiap item & lorong.", en: "The system knows each item's location & the aisles." } },
          { icon: "🧭", label: { id: "Optimasi rute", en: "Route optimization" }, detail: { id: "Algoritma mencari urutan pengambilan terpendek.", en: "The algorithm finds the shortest picking sequence." } },
          { icon: "🛡️", label: { id: "Cek keselamatan", en: "Safety check" }, detail: { id: "Menghindari tabrakan & area pekerja manusia.", en: "Avoids collisions & human-worker zones." } },
          { icon: "🤖", label: { id: "Robot menjalankan", en: "Robot executes" }, detail: { id: "Robot mengambil item mengikuti rute optimal.", en: "The robot picks items following the optimal route." } },
        ],
      },
    },
  ],
