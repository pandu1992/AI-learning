...
export const topics = [
  ...
  },
  {
    ...
    id: {
      title: "Etika AI",
      summary: "Membangun AI yang bertanggung jawab: risiko, bias & rasisme, keselamatan, keamanan, dan pengawasan manusia.",
    },
    en: {
      title: "AI Ethics",
      summary: "Building responsible AI: risks, bias & racism, safety, security, and human oversight.",
    },
  },
];
...
export const fields = [
  {
    slug: "business",
    icon: "💼",
    id: { title: "Bisnis", summary: "AI di dunia bisnis dan ritel." },
    en: { title: "Business", summary: "AI in business and retail." },
  },
  {
    slug: "industry",
    icon: "🏭",
    id: { title: "Industri", summary: "AI untuk manufaktur & industri cerdas." },
    en: { title: "Industry", summary: "AI for manufacturing & smart industry." },
  },
  {
    slug: "agriculture",
    icon: "🌾",
