...
export const demos = [
  ...
  },
  {
    slug: "regression",
    id: {
      title: "Demo: Regresi Linear & Logistik",
      summary: "Geser garis regresi dan lihat error mengecil, atau atur kurva sigmoid untuk klasifikasi.",
    },
    en: {
      title: "Demo: Linear & Logistic Regression",
      summary: "Drag the regression line to shrink the error, or tune the sigmoid curve for classification.",
    },
  },
  {
    slug: "neural-network",
    id: {
      title: "Demo: Jaringan Saraf (Neural Network)",
      summary: "Latih jaringan saraf kecil langsung di browser dan amati batas keputusannya belajar.",
    },
    en: {
      title: "Demo: Neural Network",
      summary: "Train a tiny neural network right in the browser and watch its decision boundary learn.",
    },
  },
  {
    slug: "rl-gridworld",
    id: {
      title: "Demo: Reinforcement Learning (Grid-World)",
      summary: "Agen belajar mencari reward dan menghindari jebakan lewat Q-learning.",
    },
    en: {
      title: "Demo: Reinforcement Learning (Grid-World)",
      summary: "An agent learns to find rewards and avoid traps via Q-learning.",
    },
  },
];
